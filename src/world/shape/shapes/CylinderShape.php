...
final class CylinderShape implements Shape{
	...
	public function toShapeData(int $networkId) : PacketShapeData{
		return PacketShapeData::cylinder($networkId, $this->base, $this->radiusX, $this->radiusZ, $this->height, $this->segments, $this->color, $this->dimensionId, $this->attachedEntityId);
	}
}
